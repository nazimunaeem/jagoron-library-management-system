...
.sum-item{text-align:center;background:#f0f0f0;border:1px solid #ddd;padding:10px 16px;border-radius:4px;flex:1;min-width:100px}
...
<div class="no-print">
  <button onclick="window.print()" class="btn btn-primary">🖨️ বিবরণী প্রিন্ট / ডাউনলোড</button>
  <a href="donor_certificate.php" class="btn btn-outline">📜 সনদ</a>
...
<div class="stmt">
  ...
  <div class="summary-row">
    ...
    <div class="sum-item"><strong>৳<?=number_format($d['grand_total'])?></strong><span>সর্বমোট</span></div>
    <?php endif;?>
  </div>
  <table>
